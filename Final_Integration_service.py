...
emailfrom  = " Enter your email address "                          #Senders email addr
#emailto    = "For sending mail to 1 recipient"                    #Receivers email addr
...
#################################### Writing in .csv file #########################################    
    ...
    file_exists = os.path.isfile(Date+".csv")
