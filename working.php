...
$query="SELECT * FROM tempLog ORDER BY Date DESC,Time DESC,  Bat_temp DESC, Milk_temp DESC,Aux_temp DESC,Comp_curr DESC, HP DESC, LP DESC";
...
while ($i < $num)
{
	...
	$f3=mysql_result($result,$i,"Bat_temp");
        $f4=mysql_result($result,$i,"Milk_temp");
	$f5=mysql_result($result,$i,"Aux_temp");
	$f6=mysql_result($result,$i,"Comp_curr");
	$f7=mysql_result($result,$i,"HP");
	$f8=mysql_result($result,$i,"LP");
?>
<tr>
